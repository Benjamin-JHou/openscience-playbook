# AI 사이언티스트 플레이북 (AI-Scientist Playbook)

[English](README.md) | [简体中文](README_zh.md) | [Français](README_fr.md) | [日本語](README_ja.md) | [한국어](README_ko.md) | [Español](README_es.md)

**AI 사이언티스트 플레이북**에 오신 것을 환영합니다! 이 가이드는 주요 오픈소스 AI 사이언티스트 워크벤치와 로컬 우선(local-first) 연구 플랫폼을 상세히 다루는 종합적이고 엄선된 안내서입니다. AI를 활용하여 과학 연구의 효율성을 극대화할 수 있도록 리소스 모음, 단계별 설치 안내, 자주 묻는 질문(Q&A), 그리고 고급 최적화 팁을 제공합니다.
