...
- **초기 탐색, 데이터 로드 및 라우팅**: 비용 효율이 매우 높고 뛰어난 성능을 자랑하는 최신 "Flash" 및 "Mini" 모델 사용을 권장합니다. 예를 들어, 100만 토큰 이상의 긴 문맥 창을 가져 대용량 과학 문헌이나 PDF 분석에 최적화된 **Gemini 2.5 Flash**를 사용하거나, 고성능 하위 에이전트 조율, 키워드 추출 및 워크플로우 라우팅을 위해 **GPT-4o mini** 또는 **Claude 3.5 Haiku**를 활용할 수 있습니다.
- **종합 및 논문 작성 단계**: 최종적인 깊은 과학적 추론, 논문 작성, 혹은 체계적인 연구 성실성 검증을 수행할 때만 **Claude 3.5 Sonnet** 또는 **GPT-4o**와 같은 최상위 프론티어 모델로 전환합니다.
